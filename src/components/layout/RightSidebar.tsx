    ...
    <div className="space-y-4 w-full">
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-4 w-full">
        ...
        <div className="space-y-3">
          <div className="bg-gray-50 rounded-lg p-3 border border-gray-200 hover:border-blue-300 transition-colors duration-200 w-full">
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-4 w-full">
        ...
        <div className="bg-gray-100 rounded-lg p-6 text-center min-h-[300px] flex items-center justify-center w-full">
      ...
      {/* Additional Ad Space */}
      <div className="bg-white rounded-lg border border-gray-200 p-4 w-full">
        <div className="bg-gray-100 rounded-lg p-4 text-center min-h-[250px] flex items-center justify-center w-full">
          <div className="text-gray-500">
