      ...
      <div className="bg-black px-5">
        <div className="flex justify-between items-center h-[50px]">
          <div className="flex gap-1">
            ...
            <a href="/my-tribe" className="flex items-center gap-2 px-4 py-2 text-white hover:bg-primary rounded-md transition-colors">
              <i className="fas fa-user-friends"></i>
              <span>My Tribe</span>
            </a>
            <a href="/friends" className="flex items-center gap-2 px-4 py-2 text-white bg-primary rounded-md">
